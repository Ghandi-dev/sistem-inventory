...
class Aset_Jalan extends CI_Controller
{
    ...
    {
        // Misalkan type aset adalah 'jalan', bisa Anda ganti sesuai dengan jenis aset yang diinginkan
        $type = 'jalan'; // Ini bisa disesuaikan: 'jalan', 'kendaraan', 'jalan', 'jalan', dll.
        // Set judul halaman
        ...
        $where = array(
            ...
            'jenis' => $type, // Jenis aset (jalan, kendaraan, dll.)
        );
        ...
        $this->load->view('admin/jalan/detail', $data);
    }
    ...
    public function print()
    {
        ...
        $this->load->view('admin/jalan/print', $data);
    }
}