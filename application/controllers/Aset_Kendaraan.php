...
class Aset_Kendaraan extends CI_Controller
{
    ...
    {
        // Misalkan type aset adalah 'kendaraan', bisa Anda ganti sesuai dengan jenis aset yang diinginkan
        $type = 'kendaraan'; // Ini bisa disesuaikan: 'kendaraan', 'kendaraan', 'jalan', 'kendaraan', dll.
        // Set judul halaman
        ...
        $where = array(
            ...
            'jenis' => $type, // Jenis aset (kendaraan, kendaraan, dll.)
        );
    ...
    public function print()
    {
        ...
        $this->load->view('admin/kendaraan/print', $data);
    }
}