...
class Aset_Tanah extends CI_Controller
{
    ...
    {
        // Misalkan type aset adalah 'tanah', bisa Anda ganti sesuai dengan jenis aset yang diinginkan
        $type = 'tanah'; // Ini bisa disesuaikan: 'tanah', 'kendaraan', 'jalan', 'elektronik', dll.
        // Set judul halaman
        ...
        $where = array(
            ...
            'jenis' => $type, // Jenis aset (tanah, kendaraan, dll.)
        );
