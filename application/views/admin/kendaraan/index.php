...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div id="content" class="content">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <span><?php echo anchor('aset_kendaraan/detail/' . $as->id_aset, '<div  class="btn btn-success btn-sm"><i class="fa fa-eye"></i></div>') ?>
                                        </span>|
                                        <span><?php echo anchor('aset_kendaraan/edit/' . $as->id_aset, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?>
                                        </span>|
                                        <span>
            ...
            <?php $this->load->view('admin/kendaraan/modal_tambah');?>
        </div>
    ...
    $('#print').click(function() {
        ...
        var jenis = $('#jenis').val();
        window.open('<?php echo base_url('/aset_kendaraan/print') ?>?min=' + min + '&max=' + max +
            '&nama_aset=' +
            search +
            '&type=' + jenis,
            '_blank');
