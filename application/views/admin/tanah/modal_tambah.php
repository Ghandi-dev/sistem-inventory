        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <form id="assetForm"
                            action="<?php echo site_url('admin/create?type=' . strtolower(str_replace(' ', '_', $title))); ?>"
                            ...
                            <div class="mb-3">
                                <label for="merk" class="form-label">Luas (M<sup>2</sup>)</label>
                                <input type="text" class="form-control" name="merk" placeholder="Masukkan luas tanah"
                                    required>
                            </div>
                            <div class="mb-3">
